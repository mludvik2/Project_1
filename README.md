...
This Python project is a **text analysis tool** designed to analyze multiple predefined texts and provide insights about their content. It was created as part of the Engeto Online Python Academy, Project 1.

The program allows a registered user to:
